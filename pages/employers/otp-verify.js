...
//   const [activeOtpType, setActiveOtpType] = useState("email"); // 'email' or 'mobile'
...
//   const handleOtpChange = (index, value, type = "email") => {
...
//   const handleKeyDown = (index, e, type = "email") => {
//     if (
//       e.key === "Backspace" &&
//       !(type === "email" ? otpValues[index] : mobileOtpValues[index]) &&
//       index > 0
//     ) {
//       if (type === "email") {
//         otpRefs.current[index - 1]?.focus();
...
//   const handlePaste = (e, type = "email") => {
//     e.preventDefault();
...
//     const emailOtpCode = otpValues.join("");
//     const mobileOtpCode = mobileOtpValues.join("");

//     // Check if at least one OTP is provided
//     if (emailOtpCode.length !== 6 && mobileOtpCode.length !== 6) {
//       Swal.fire({
//         icon: "error",
//         title: "Incomplete OTP",
//         text: "Please enter either email OTP or mobile OTP (6 digits each)",
//       });
//       return;
//     }
...
//         userId: userId,
//         roleId: roleId,
//         emailOtp: emailOtpCode.length === 6 ? emailOtpCode : null,
//         mobileOtp: mobileOtpCode.length === 6 ? mobileOtpCode : null,
//       };
...
//           icon: "success",
//           title: "OTP Sent",
//           text: "New verification codes have been sent to your email and mobile",
//           timer: 1500,
//           showConfirmButton: false,
//         });
...
//     // Mock verification logic - accept either email OTP "123456" or mobile OTP "654321"
...
//                   <small>
//                     Enter either email OTP or mobile OTP to verify your account
//                   </small>
//                 </div>
//               </div>
...
export default function VerifyOTP() {
  ...
  // Get userId and roleId from URL query parameters
  ...
  const handleOtpSubmit = async () => {
    ...
    try {
      const payload = {
        userId: userId,
        roleId: roleId,
        emailOtp: null, // Set to null for employers (same as employees)
            ...
            <div className="card login-form-card border-0 mx-auto">
              <div className="card-body p-5">
                ...
                <button
                  ...
                  onClick={handleOtpSubmit}
                  disabled={
                    isVerifying || mobileOtpValues.join("").length !== 6
                  }
                >
                  {isVerifying ? (
                    <>
