                ...
                <div className="jobseeker-tab-content">
                  ...
                  {activeTab === "about" && (
                    <div>
                      ...
                      <p className="lead">
                        Creative and detail-oriented professional with
                  ...
                  {/* {activeTab === "portfolio" && (
                    <div style={{ overflow: "auto" }}>
                      ...
                      {user.certifiedTags && user.certifiedTags.length > 0 ? (
                        <div className="jobseeker-portfolio-grid">
                          {user.certifiedTags.map((cert, index) => (
                            <div
                              key={index}
                              className="jobseeker-portfolio-item"
                            >
                              {cert}
                            </div>
                          ))}
